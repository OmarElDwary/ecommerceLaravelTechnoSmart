...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Techno Star">
    <meta name="msapplication-TileImage" content="assets/images/favicon.ico">
    <meta name="msapplication-TileColor" content="#FFFFFF">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Techno Star">
    <meta name="keywords" content="Techno Star">
    <meta name="author" content="Techno Star">
    <link rel="preconnect" href="https://fonts.gstatic.com">

    <title>Techno Star</title>
                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{route('app.index')}}">
                                        <img src="{{ asset('assets/images/Untitled-1.png') }}" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="{{route('app.index')}}" class="footer-logo float-start">
                                    <img src="{{ asset('assets/images/Untitled-1.png') }}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
