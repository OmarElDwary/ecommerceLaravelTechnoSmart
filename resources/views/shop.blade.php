                                                ...
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands"
                                                            ...
                                                            value="{{$brand->id}}" onchange="filterBrands(this)" type="checkbox">
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="ct{{$category->id}}" name="categories"
                                                            ...
                                                            onchange="filterCategories(this)" @if(in_array($category->id,explode(',',$q_categories))) checked="checked" @endif
                                                        >
                            ...
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    {{-- <div class="cart-wrap">
                                        <ul>
                                            <li>
                                                <a href="javascript:void(0)" onclick="event.preventDefault();document.getElementById('addtocart').submit()"; class="addtocart-btn">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        ...
                                        {{-- <button class="btn listing-content" onclick="event.preventDefault();document.getElementById('addtocart').submit();">
                                            Add to cart
                                            <form id="addtocart" method="post"
                                                action="{{route('cart.store')}}">
                                                @csrf
